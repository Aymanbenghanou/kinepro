...
export default function AgendaClient({ initialRdvList }: { initialRdvList: any[] }) {
  ...
  const [rdvList, setRdvList]         = useState<any[]>(initialRdvList)
  ...
  useEffect(() => {
    // initialRdvList déjà fourni en SSR (perf P2) — fetchRdv() reste
    // disponible pour les refresh post-mutation (création/suppression/
    // drag-drop). Les 3 dropdowns sont chargés au mount comme avant.
